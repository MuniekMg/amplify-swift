public protocol GraphQLResultAccumulator: AnyObject {
  ...
  func accept(scalar: JSONValueAny, info: GraphQLResolveInfo) throws -> PartialResult
...
public final class Zip2Accumulator<Accumulator1: GraphQLResultAccumulator, Accumulator2: GraphQLResultAccumulator>: GraphQLResultAccumulator {
  ...
  public func accept(scalar: JSONValueAny, info: GraphQLResolveInfo) throws -> PartialResult {
